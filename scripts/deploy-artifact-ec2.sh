...
require_file "$RELEASE_DIR/patches/brace-expansion@5.0.9.patch"
require_file "$RELEASE_DIR/scripts/start-server.mjs"
require_file "$RELEASE_DIR/scripts/cache-policy.mjs"
...
require_file "$RELEASE_DIR/dist/client/.vite/manifest.json"
